...
7. In your lib folder, copy and paste all files inside the lib folder from the downloaded JavaFX folder ***(C:/openjfx-20.0.1_windows-x64_bin-sdk/javafx-sdk-20.0.1/lib)***
